                    ...
                    <div class="d-flex flex-row">
                        ...
                        <div class="col-xl-5 ">
                            ...
                            <div class="card mb-6  align-items-center" style="height: 20rem;">
                                ...
                                <div class="card-body text-center mx-5 my-5">
                                    ...
                                    <button class="btn btn-primary mx-3 my-3" type="button">Upload new image</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-7 ">
                            ...
                            <div class="card mb-6  align-items-center border-0" style="height: 20rem;">
                                ...
                                <textarea class="form-control mx-3 my-2 col-50" style="height: 20rem; wid"
                                    id="inputUsername" type="text"></textarea>
